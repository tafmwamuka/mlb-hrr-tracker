...
import { Trophy, TrendingUp, Zap, Target, CheckCircle2, XCircle, Clock, Flame, BarChart3, Award, Star, RefreshCw, Radio, DollarSign } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { trpc } from "@/lib/trpc";
import { SaferPlayTip } from "./SaferPlayTip";
import { useState, useEffect, useMemo } from "react";

// Phase BD: SevenDayStatsCard and HistoricalPerformancePanel removed from Results tab
// These components are now part of the Stats tab (PerformanceDashboard)
...
export function ResultsTab() {
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20">
      ...
      {/* Results List — Phase BD: SevenDayStatsCard and HistoricalPerformancePanel moved to Stats tab */}
