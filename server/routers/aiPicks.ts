            ...
            try {
              ...
              for (const p of moneyPicks3 as any[]) {
                ...
                await insertPickSnapshotIfNew({
                  ...
                  openingOdds: (p as any).openingOdds ?? null,
                  bestAvailableOdds: (p as any).bestAvailableOdds ?? null,
                  bestAvailableBook: (p as any).bestAvailableBook ?? null,
                  ...
                  tier: p.isFilledPick ? 'Projection' : p.overallScore >= 83 ? 'Elite' : p.overallScore >= 74 ? 'Official' : p.overallScore >= 68 ? 'Lean' : 'Projection',
                  boardPhase,
          ...
          void (async () => {
            try {
              ...
              const rows = moneyPicks3.map((p: any) => ({
                ...
                tier: p.isFilledPick ? 'Projection' : p.overallScore >= 83 ? 'Elite' : p.overallScore >= 74 ? 'Official' : p.overallScore >= 68 ? 'Lean' : 'Projection',
                category: 'MoneyPick',
                isOfficialPlay: (p.isFilledPick || (p.overallScore ?? 0) < 68) ? 0 : 1,
                edge: null,
