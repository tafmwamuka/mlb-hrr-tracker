...
const MOCK_MATCHUPS = [
  {
    ...
    position: "RF",
    battingPosition: 4,
    pitcher: { name: "Framber Valdez", team: "HOU", handedness: "L", era: 3.01 },
    rc: 38,
    confidence: 88,
  },
  {
    ...
    position: "LF",
    battingPosition: 3,
    pitcher: { name: "Kevin Gausman", team: "TOR", handedness: "R", era: 3.25 },
    rc: 42,
    confidence: 92,
  },
  {
    ...
    position: "CF",
    battingPosition: 2,
    pitcher: { name: "Drew Rasmussen", team: "TB", handedness: "R", era: 3.89 },
    rc: 35,
    confidence: 82,
  },
  {
    ...
    position: "DH",
    battingPosition: 5,
    pitcher: { name: "Gerrit Cole", team: "NYY", handedness: "R", era: 3.41 },
    rc: 40,
    confidence: 85,
  },
  {
    ...
    position: "LF",
    battingPosition: 3,
    pitcher: { name: "Camilo Doval", team: "SF", handedness: "R", era: 3.55 },
    rc: 33,
    confidence: 78,
  },
  {
    ...
    position: "LF",
    battingPosition: 3,
    pitcher: { name: "Max Scherzer", team: "NYM", handedness: "R", era: 3.42 },
    rc: 36,
    confidence: 80,
  },
  {
    ...
    position: "C",
    battingPosition: 6,
    pitcher: { name: "Logan Gilbert", team: "SEA", handedness: "R", era: 3.71 },
    rc: 28,
    confidence: 72,
  },
  {
    ...
    position: "DH",
    battingPosition: 2,
    pitcher: { name: "Clayton Kershaw", team: "LAD", handedness: "L", era: 3.35 },
    rc: 41,
    confidence: 89,
  },
  {
    ...
    position: "2B",
    battingPosition: 7,
    pitcher: { name: "Sonny Gray", team: "STL", handedness: "R", era: 3.68 },
    rc: 26,
    confidence: 68,
  },
  {
    ...
    position: "C",
    battingPosition: 8,
    pitcher: { name: "Blake Snell", team: "SF", handedness: "L", era: 3.12 },
    rc: 24,
    confidence: 65,
  },
];
